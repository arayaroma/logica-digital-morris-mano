...
n\'{u}mero $N$ de $n$ d\'{i}gitos en base $r$ se define como:
\begin{center}
    $r^n - N$, para $N \neq 0$, y 0 para $N = 0$.
\end{center}
Por ejemplo, el complemento a 10 de 1234 es $10^4 - 1234 = 8766$. De forma similar, el
...
por unos en las demás posiciones a la izquierda.
\begin{center}
...
De igual manera, dado un n\'{u}mero $N$ en base $r$ que tiene $n$ d\'{i}gitos,
el complemento a $(r - 1)$ de $N$ se define como:
\begin{center}
    $(r^n - 1) - N$.
\end{center}
...
n\'{u}mero binario que consite en un uno seguido de $n$ ceros.
\begin{center}
